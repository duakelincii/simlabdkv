    ...
    <li class="nav-item {{ active('barang', 'active', 'group') }}">
      ...
      <div id="barang" class="collapse {{ active('barang', 'show', 'group') }}">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item {{ active('barang', 'active') }}" href="{{ route('barang.index') }}">Data Barang</a>
          <a class="collapse-item {{ active('barang/create', 'active') }}" href="{{ route('barang.create') }}"> Tambah Barang</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item {{ active('stock', 'active', 'group') }}">
      ...
      <div id="stock" class="collapse {{ active('stock', 'show', 'group') }}">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item {{ active('stock/add', 'active') }}" href="{{ route('stock.add') }}">Stock Masuk</a>
          <a class="collapse-item {{ active('stock/remove', 'active') }}" href="{{ route('stock.remove') }}">Stock Keluar</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item {{ active('member', 'active', 'group') }}">
      ...
      <div id="member" class="collapse {{ active('member', 'show', 'group') }}">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item {{ active('member/create', 'active') }}" href="{{ route('member.create') }}">Add Member</a>
        </div>
      </div>
    </li>
